...
public class DataTracker : MonoBehaviour
{
    ...
    private string baseURL = "https://simuladoresdata-default-rtdb.firebaseio.com"; //URL SIN BARRITA AL FINAL PORQUE YA ESTA EN BUILD.URL()
    public string gameName = "shootingGame";
    ...
    public Game CreateGame() //SE SACA DEL PUT PARA MEJOR ORGANIZACIÓN, SE PUEDE POINER EN OTRA CLASE
    {
        Game game = new Game();
